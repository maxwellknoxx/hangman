...
public class CategoryController {
	...
	/*
	 * @PostMapping(path = "/api/category/addCategory") public
	 * ResponseEntity<Response<Category>> addCategory(@Valid @RequestBody Category
	 * category, BindingResult result) { Response<Category> response = new
	 * Response<>(); Category categoryFromDB = new Category();
	 * 
	 * try { categoryFromDB = service.addCategory(category);
	 * response.setData(categoryFromDB); response =
	 * responseUtils.setMessages(response, category.getCategoryName() +
	...
	/*
	 * @PostMapping(path = "/api/category/updateCategory") public
	 * ResponseEntity<Response<Category>> updateCategory(@Valid @RequestBody
	 * Category category, BindingResult result) { Response<Category> response = new
	 * Response<>(); Category categoryFromDB = new Category();
	 * 
	 * try { categoryFromDB = service.updateCategory(category);
	 * response.setData(categoryFromDB); response =
	 * responseUtils.setMessages(response, category.getCategoryName() +
